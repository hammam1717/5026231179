...
<head>
    ...
    <script>
        function formvalidation() {
            ...
            var regexHuruf = /^[A-Za-z]+$/;
            if (!regexHuruf.test(nama)) {
                Swal.fire({
                    title: "Pesan Kesalahan",
                    text: "Nama tidak boleh mrngandung angka!",
                    icon: "error"
                });
                document.getElementById("nama").focus();
                return false;
...
<body>
    <div class="container">
        ...
        <form id="formpendaftaran" action="https://google.co.id"
            method="get" onsubmit="return formvalidation();">
            NRP :
            ...
            <input type="text" id="nama" class="form-control"
                placeholder="Silahkan Isi Nama, huruf saja tanpa spasi"
                name="nama">
            <br>
